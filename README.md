...
Instead of setting width to the container of the entire document, It would  
be best to rather set the width of the container to 100%, and rather give a  
padding to the individual in the container...
